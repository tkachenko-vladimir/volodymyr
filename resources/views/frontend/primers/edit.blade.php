        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.primer.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.primers.update", [$primer->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="originalr_o">{{ trans('cruds.primer.fields.originalr_o') }}</label>
                            <input class="form-control" type="text" name="originalr_o" id="originalr_o" value="{{ old('originalr_o', $primer->originalr_o) }}">
