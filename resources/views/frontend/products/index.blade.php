                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-Product">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.product.fields.name_file') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.product.fields.translator') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.product.fields.translator_page') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
                            ...
                            <tbody>
                                @foreach($products as $key => $product)
                                    <tr data-entry-id="{{ $product->id }}">
                                        ...
                                        <td>
                                            {{ $product->translator->fio ?? '' }}
                                        </td>
                                        <td>
                                            {{ $product->translator_page ?? '' }}
                                        </td>
                                        <td>
                                            @can('product_show')
