...
class NotarizationController extends Controller
{
    public function index()
    {
        ...
        return view('admin.notarizations.index', compact('notarizations'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.notarizations.create', compact('client_docums'));
    }
    ...
    public function store(StoreNotarizationRequest $request)
    {
        ...
        return redirect()->route('admin.notarizations.index');
    }
    ...
    public function edit(Notarization $notarization)
    {
        ...
        return view('admin.notarizations.edit', compact('client_docums', 'notarization'));
    }
    ...
    public function show(Notarization $notarization)
    {
        ...
        return view('admin.notarizations.show', compact('notarization'));
    }
