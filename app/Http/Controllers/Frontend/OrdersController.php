...
class OrdersController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.orders.create', compact('client_orders', 'languages_nas', 'languages_s', 'products'));
    }
    ...
    public function edit(Order $order)
    {
        ...
        return view('frontend.orders.edit', compact('client_orders', 'languages_nas', 'languages_s', 'order', 'products'));
    }
